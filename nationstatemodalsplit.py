...
def nationstatemodalsplit(year_int, base_dir):
    ...
    def download_and_save_data(acs_dict, fips, location, api_key, api_url_base, base_dir, table):
        ...
        while api_calls_done < api_calls_needed:
            ...
            if location == 'Ohio':
                api_url = api_url_base + get_string + '&for=state:' + fips[location] + '&key=' + api_key
            else:
                api_url = api_url_base + get_string + '&for=us:*&key=' + api_key
